...
import os
import re
from sixel import convert_from_file
import requests
import tempfile
...
def display_image(image_path):
    ...
    try:
        # Assuming the image is in a local directory
        print(convert_from_file(image_path))
...
while True:
    ...
    # Select questions with the minimum score
    ...
    # Ask the user if they want to increment the third column
    while True:
        totalq = (totalq + 1)
